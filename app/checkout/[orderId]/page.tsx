    ...
    <div className="min-h-[80vh] py-8 md:py-16 relative">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <ScrollAnimate animation="fade-up">
          <nav className="flex items-center text-xs font-semibold uppercase tracking-wider text-gray-400 mb-8 space-x-3 bg-white/80 backdrop-blur-sm w-fit px-5 py-2.5 rounded-full border border-indigo-100 shadow-sm">
            <Link
              href="/"
          ...
          <div className="lg:col-span-5 lg:order-2">
            <div className="sticky top-28 space-y-6">
              ...
              <ScrollAnimate animation="slide-right">
                <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-3xl p-8 text-white shadow-2xl shadow-gray-900/30 overflow-hidden">
              ...
              <div className="grid grid-cols-2 gap-4">
                <ScrollAnimate animation="fade-up" delay={100}>
                  <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 border border-indigo-100 flex items-center gap-3">
