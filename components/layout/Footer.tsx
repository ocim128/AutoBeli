    ...
    <footer className="border-t border-[var(--line)] bg-[var(--panel)] mt-auto">
      <div className="mx-auto max-w-6xl px-4 pt-10 pb-8">
        ...
        <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between lg:gap-12">
          ...
          {/* Navigation — compact single group */}
          <nav className="flex flex-wrap items-center gap-x-6 gap-y-2">
            <Link
              href="/#products"
              className="font-mono text-[11px] uppercase tracking-wider text-[var(--text-muted)] hover:text-[var(--foreground)] transition-colors"
            >
              {t("common.browse")}
            </Link>
            <Link
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 font-mono text-[11px] uppercase tracking-wider text-[var(--text-muted)] hover:text-[var(--foreground)] transition-colors"
            >
        ...
        {/* ── Trust signals — subtle inline row ── */}
        <div className="mt-6 flex flex-wrap items-center gap-x-5 gap-y-1">
          <span className="inline-flex items-center gap-1.5 font-mono text-[10px] uppercase tracking-widest text-[var(--text-muted)]">
