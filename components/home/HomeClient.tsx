      ...
      <section id="products" className="scroll-mt-24">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4 border-l-4 border-indigo-600 pl-6">
          <div>
            ...
            <p className="text-gray-500 font-medium mt-1">{t("home.curatedCollection")}</p>
          </div>
        ...
        {products.length === 0 ? (
          <div className="text-center py-24 bg-gray-50 rounded-3xl border-2 border-dashed border-gray-200">
            ...
            <p className="text-gray-500 font-bold text-lg">{t("home.inventoryEmpty")}</p>
            <p className="text-gray-400">{t("home.checkBack")}</p>
          </div>
        ) : (
