...
export function ProductClient({ product }: { product: Product }) {
  ...
  return (
    <div className="max-w-6xl mx-auto pb-20">
      ...
      <nav className="flex items-center text-xs font-semibold uppercase tracking-wider text-gray-400 mb-12 space-x-3 bg-white/80 backdrop-blur-sm w-fit px-5 py-2.5 rounded-full border border-indigo-100 shadow-sm scroll-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-7 space-y-10">
          ...
          <div className="aspect-[16/10] relative overflow-hidden rounded-3xl bg-gray-900 shadow-2xl shadow-indigo-500/20 flex items-center justify-center group scroll-scale-in">
            {product.imageUrl ? (
              <>
          ...
          {/* Description Section */}
          <div className="space-y-8 bg-white p-8 md:p-10 rounded-3xl border border-gray-100 shadow-lg shadow-gray-100/50 scroll-fade-in stagger-1">
            <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {features.map((feature, i) => (
                <div
                  key={i}
                  className={`group flex gap-4 p-5 rounded-2xl bg-gradient-to-br from-gray-50 to-white border border-gray-100 hover:border-indigo-200 hover:shadow-md transition-all scroll-fade-in stagger-${i + 2}`}
                >
        ...
        <div className="lg:col-span-5 sticky top-28 space-y-6 scroll-slide-right">
          ...
          <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-3xl p-8 md:p-10 text-white shadow-2xl shadow-indigo-600/20 overflow-hidden">
            ...
            <div className="relative">
              ...
              <h1 className="text-2xl md:text-3xl font-bold mb-2 leading-tight">{product.title}</h1>
          ...
          {/* Trust Badge */}
          <div className="bg-gradient-to-br from-indigo-50 to-white rounded-2xl p-5 border border-indigo-100 flex items-center gap-4 scroll-fade-in stagger-2">
